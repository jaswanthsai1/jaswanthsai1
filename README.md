...
![Parrot OS](https://img.shields.io/badge/Parrot_OS-15B7B9?style=for-the-badge&logo=parrot-security&logoColor=white)
...
![Hashcat](https://img.shields.io/badge/Hashcat-EE0000?style=for-the-badge&logo=hashcat&logoColor=white)
...
class BugHunter:
    def __init__(self):
        ...
        self.alias = "0xJaswanth"
        self.focus = ["Web Pentesting", "OSINT", "API Security", "PrivEsc"]
        self.mindset = "Think like an attacker, defend like a guardian"

    def hunt(self):
        while True:
            target = self.recon()
            if vuln := self.find_vulnerability(target):
                self.report_responsibly(vuln)  # 🛡️ always ethical

hunter = BugHunter()
hunter.hunt()  # >>> Making the web safer, one bug at a time 🔐
```
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/jaswanthsai1)
